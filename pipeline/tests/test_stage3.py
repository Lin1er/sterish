...
from sterish_pipeline.models import AuditReport, FinalVerdict, Stage1Result, Stage2Result
...
class TestStage3:
    def test_safe_verdict(self):
        ...
        stage2 = Stage2Result()
        cfg = PipelineConfig(
            safe_threshold=70, warning_threshold=40, stage1_weight=50, stage2_weight=50
        )
    ...
    def test_dangerous_verdict_low_score(self):
        ...
        cfg2 = PipelineConfig(
            safe_threshold=70, warning_threshold=40, stage1_weight=100, stage2_weight=0
        )
